...
Connect-PnPOnline -Url $env:SHAREPOINT_SITE_URL -ClientId $env:INGESTION_CLIENT_ID -Tenant $env:DEPLOYMENT_TENANT_ID -CertificatePath $certPath -CertificatePassword ""
